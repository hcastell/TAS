...
{
	/// <summary>
	/// Summary description for WSTTC.
	/// <methods className='WSTTC' >
	///  <method  hasInput='true' />
	/// </methods>
	/// </summary>
	public class WSTTC : HostSystem
	{
		public WSTTC()
		{
		...
		#region WSTTC
		/// <summary>
		/// Web Service method for WSTTC.
		/// </summary>
		/// <param name="inputObj">WSTTC_Input</param>
		/// <returns>WSTTC_Output</returns>
		public virtual WSTTC_Output M_WSTTC(WSTTC_Input inputObj)
		{
			if (inputObj == null)
				this.ThrowHostExceptionClient("Did not receive a 'WSTTC_Input' object.");

			// Create session with the host system.
			this.OpenHostSession();

			// Set the current ispec.
			this.SetCurrentIspec("WSTTC");
			...
			this.SetIspecFieldValue("ACOTIPUTI", inputObj.ACOTIPUTI, "ACOTIPUTI");
			this.SetIspecFieldValue("TNUCUENTA", inputObj.TNUCUENTA, "TNUCUENTA");
			...
			WSTTC_Output outputObj = new WSTTC_Output();
			...
			outputObj.ACOTIPUTI = this.GetIspecFieldFormattedValue("ACOTIPUTI", true);
			outputObj.TNUCUENTA = this.GetIspecFieldFormattedValue("TNUCUENTA", true);
	...
	/// <summary>
	/// <inputParameters className='WSTTC_Input' >
	...
	public class WSTTC_Input
	{
		...
		[XmlElement(DataType="integer")] public string ACOTIPUTI;
		[XmlElement(DataType="integer")] public string TNUCUENTA;
