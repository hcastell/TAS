...
{
	/// <summary>
	/// Summary description for WS200.
	/// <methods className='WS200' >
	///  <method  hasInput='true' />
	/// </methods>
	/// </summary>
	public class WS200 : HostSystem
	{
		public WS200()
		{
		...
		#region WS200
		/// <summary>
		/// Web Service method for WS200.
		/// </summary>
		/// <param name="inputObj">WS200_Input</param>
		/// <returns>WS200_Output</returns>
		public virtual WS200_Output M_WS200(WS200_Input inputObj)
		{
			if (inputObj == null)
				this.ThrowHostExceptionClient("Did not receive a 'WS200_Input' object.");

			// Create session with the host system.
			this.OpenHostSession();

			// Set the current ispec.
			this.SetCurrentIspec("WS200");
			...
			WS200_Output outputObj = new WS200_Output();
	...
	/// <summary>
	/// <inputParameters className='WS200_Input' >
